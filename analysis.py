                ...
                for m in range(10):
                    ...
                    while True:
                        ...
                        if steering is not None:
                            break
                print(i,k,j,left_wheel_speed,right_wheel_speed,steering)
                writer.writerow([i,k,j,left_wheel_speed,right_wheel_speed,steering,(left_wheel_speed+right_wheel_speed)/2])


df = pd.read_csv('data.csv', header=None, names=['i', 'k', 'j', 'left_wheel_speed', 'right_wheel_speed', 'steering', 'speed'])
